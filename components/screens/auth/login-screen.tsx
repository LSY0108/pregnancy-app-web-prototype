    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex-1 px-6 py-8">
        <div className="flex flex-col gap-2 mb-8">
          ...
          <HelperText>Enter your email and password to continue</HelperText>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="flex gap-3">
            <button className="flex-1 h-12 rounded-xl border border-border flex items-center justify-center gap-2 text-sm font-medium text-foreground hover:bg-muted transition-colors">
